...
def test_verify_dir_light_and_full(tmp_path: Path) -> None:
    ...
    assert (back_dir / "a.txt").read_text(encoding="utf-8") == (in_dir / "a.txt").read_text(encoding="utf-8")
