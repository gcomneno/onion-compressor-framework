...
> Queste mappature sono *stabili*: cambiare i codici rompe compatibilità dei file scritti.
...
- bytes compressi
- meta per-stream (attualmente opzionale e tipicamente vuoto)
...
## 2.4 Regole pratiche di decodifica

- Se nel payload v6 trovi `magic == "MBN"`, il decoder:
  1) decodifica tutti gli stream
