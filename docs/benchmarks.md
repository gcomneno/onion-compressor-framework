...
Questi numeri servono **solo** come termometro (proto). Cambieranno al cambiare di layer, codec e packaging.
...
- v5 bundle tende a fare meglio del legacy quando riesce a comprimere anche ciò che prima era “meta/vocab” non compresso o compresso male.
